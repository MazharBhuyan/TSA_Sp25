...
wind_data <- read.csv(file="/Users/mazharulhaque/TSA_Sp25/TSA_Sp25/Data/Wind_Speed_PortArthurTX_Processed.csv",header=TRUE, stringsAsFactors = TRUE)
...
clean_wind_data_fun2 <- forecast::na.interp (ts_wind_data)

autoplot(clean_wind_data_fun2, series="Wind Clean") +
  autolayer(ts_wind_data, series="Wind Raw") +
  ylab("Average Wind Speed") 


clean_wind_data_fun3 <- zoo::na.approx(ts_wind_data)
autoplot(clean_wind_data_fun3, series="Wind Clean") +
  autolayer(ts_wind_data, series="Wind Raw") +
  ylab("Average Wind Speed") 
