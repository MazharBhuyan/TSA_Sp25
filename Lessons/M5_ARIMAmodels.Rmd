...
autoplot(ts_electricity_price[,"Residential"], "additive")
...
plot_grid(
  ...
  autoplot(Pacf(deseasonal_residential_price, lag = 40, plot=FALSE),  
                  main = "Deseason Residential Electricity Price"),
  autoplot(Oacf(deseasonal_residential_price_diff, lag = 40, plot=FALSE),  
                  main = "Diff/Deseason Residential Electricity Price")
)
```
...
#y_t = 0.6312*y_t-1 - 0.7426*a_t-1 + a_t
...
```{r}
Model_autofit <- auto.arima(deseasonal_residential_price, max.D = 0,
                            max.P = 0,
                            max.Q = 0
                            )
